...
GET /tokens/:address
200: {"address":"0x","type":"ERC20|ERC721","name":"string","symbol":"string","paused":bool,"transferLocked":bool,"permissionless":bool,"owner":"0x","creator":"string"}
...
POST /tokens/:address/pause — no body, 200: {"success":true} (halts all operations)
POST /tokens/:address/unpause — no body, 200: {"success":true}
POST /tokens/:address/lock-transfers — no body, 200: {"success":true}
POST /tokens/:address/unlock-transfers — no body, 200: {"success":true}
